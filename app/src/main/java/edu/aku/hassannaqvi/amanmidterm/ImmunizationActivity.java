...
public class ImmunizationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppMain.chCount++;
        childCount.setText("(" + AppMain.chCount + " of " + AppMain.chTotal + ")");
        ...
        imAgeDob.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    imd.setMinDate(new Date().getTime() - (AppMain.MILLISECONDS_IN_YEAR * 5));
        ...
        if (formValidation()) {
            ...
            if (UpdateDG()) {
                ...
                if (AppMain.chCount < AppMain.chTotal) {
                    ...
                    secE = new Intent(this, ImmunizationActivity.class);
                } else {
                    Toast.makeText(this, "Starting Section E", Toast.LENGTH_SHORT).show();
                    secE = new Intent(this, KAPActivity.class);
                }
                startActivity(secE);
            } else {
    ...
    private boolean UpdateDG() {
        ...
        AppMain.im.setId(String.valueOf(rowId));
    ...
    private void SaveDraft() throws JSONException {
        ...
        im.put("impsu_hh", AppMain.fc.getMna4() + AppMain.fc.getMna5());
        ...
        AppMain.im.setIM(String.valueOf(im));
        AppMain.im.setUID(AppMain.fc.getDeviceID() + AppMain.fc.getID());
