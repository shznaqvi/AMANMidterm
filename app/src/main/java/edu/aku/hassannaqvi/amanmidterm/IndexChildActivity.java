...
public class IndexChildActivity extends Activity {
    ...
    private static final String TAG = IndexChildActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mnb5.setMaxDate(System.currentTimeMillis() - ((AppMain.MILLISECONDS_IN_DAY * 30) * 6));
        mnb5.setMinDate(System.currentTimeMillis() - ((AppMain.MILLISECONDS_IN_DAY * 30) * 11) + AppMain.MILLISECONDS_IN_DAY * 29);
    ...
    public void submitSecB(View v) throws JSONException {
        ...
        if (ValidateForm()) {
            ...
            if (UpdateDB()) {
                ...
                Intent secB = new Intent(this, ChildVaccinationActivity.class);
                startActivity(secB);
            } else {
